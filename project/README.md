...
### Повторно сдаю Домашнее задание "Разделение доступа в DRF".

### По замечанию №1. Добавил фильтрацию по статусу. Проверить можно с помощью запроса №7
### По замечанию №2. Изменил валидацию. Сначала происходит проверка - приходил ли запрос на закрытие объявления от пользователя или администратора, если приходит то закрываем объявление. Если нет то идем дальше и считаем кол-во открытых обяъвлений. Если больше 10 выдаем ошибку, если меньше - разрешаем создать объявление.
### По замечанию №3. Изменил permission, пользователь может закрывать обяъвления. Проверить можно с помощью запроса №4.  
### По замечанию №4. Изменил get_permissions, has_object_permission, сделал по вашему шаблону. 
### По замечанию №5. Переделывать уже на стал. 
